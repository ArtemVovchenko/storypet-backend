...
func (s *PostgreDatabaseStore) IoTDevicesRepository() repos.IoTDevicesRepository {
	if s.ioTDevicesRepository != nil {
		return s.ioTDevicesRepository
	}
	s.ioTDevicesRepository = &IoTDevicesRepository{
		store: s,
	}
	return s.ioTDevicesRepository
}
